...
[gongkao.ha7ch.com](https://gongkao.ha7ch.com)

把下面这段 prompt 粘进 Claude Code / Codex / Cursor：

```
跑 `npx @ha7ch/gongkao-pro@latest help` 把命令摸清楚，然后帮我选 2026 年国考岗位。
...
`gongkao-pro` is a CLI + MCP server that grounds an AI conversation in
